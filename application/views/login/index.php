...
<div class="login-box">
	...
	<div class="login-box-body">
        ...
        <h3 class="page-header text-center">Digital Signature<br/><br/></h3>
		...
		if(isset($message)){
			?>
			<p align="center"><span class="alert" role="alert"> <?=$message?> </span></p>
			<?php
		}
		?>
		...
		<div class="form-group">
			<input type="text" name="security_code" class="form-control" placeholder="Captcha" required>
		</div>
		<div class="row">
			<!-- /.col -->
			<div class="col-xs-4">
